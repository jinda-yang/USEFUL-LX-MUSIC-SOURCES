/*!
 * @name 聆川
 * @description 正与名字一样，暗含沉浸于音乐的的深意
 * @version V5.0.2（免费）
 * @author guoyue2010
...
// 服务端地址
const API_URL = "http://vip.xg.frp.one:48517"
// 服务端配置的请求key
const API_KEY = `guoyue2010`
// 音质配置(key为音源名称,不要乱填.如果你账号为VIP可以填写到hires)
// 全部的支持值: ['128k', '320k', 'flac', 'flac24bit']
const MUSIC_QUALITY = JSON.parse('{"kw":["128k","320k"],"kg":["128k"],"tx":["128k","320k"],"wy":["128k","320k"],"mg":["128k"]}')
...
// MD5值,用来检查更新
const SCRIPT_MD5 = 'fc72601d804ee2754c6001ac72b7a3d8'
