...
// 服务端地址
const API_URL = "http://xg.3.frp.one:28641"
// 服务端配置的请求key
const API_KEY = `guoyue2010`
// 音质配置(key为音源名称,不要乱填.如果你账号为VIP可以填写到hires)
// 全部的支持值: ['128k', '320k', 'flac', 'flac24bit']
const MUSIC_QUALITY = JSON.parse('{"kw":["128k"],"kg":["128k"],"tx":["128k"],"wy":["128k","320k"],"mg":["128k"]}')
...
// MD5值,用来检查更新
const SCRIPT_MD5 = '4cadf64a716d11dffb9136d1df341177'
