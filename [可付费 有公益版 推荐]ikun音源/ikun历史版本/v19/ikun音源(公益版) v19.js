...
const API_KEY = ""
const SCRIPT_MD5 = "f58b37e2705e2540eabf2ea38c5899a5";
...
const handleGetCdnUrl = async () => {
    ...
    const {body} = request;
    console.log(body)
    if (!body || isNaN(Number(body.code))) return "http://ws.stream.qqmusic.qq.com";
    return getRandom(body.req?.data?.freeflowsip)
}
...
const handleGetMusicUrl = async (source, musicInfo, quality) => {
    ...
    switch (body.code) {
        case 200:
            ...
            if (body.clientcdn) {
                const cdnUrl = await handleGetCdnUrl();
                return cdnUrl + body.url;
            }
            return body.url;
        case 403:
            console.log(
